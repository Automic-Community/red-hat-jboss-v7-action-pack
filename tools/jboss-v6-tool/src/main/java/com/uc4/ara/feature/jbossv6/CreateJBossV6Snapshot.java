...
import com.uc4.ara.feature.jbossv6.schemas.JBossV6SnapshotType;
...
public class CreateJBossV6Snapshot extends AbstractInternalFeature  {
    ...
    public int run(String[] args) throws Exception {
        ...
        JAXBContext context = JAXBContext.newInstance(JBossV6SnapshotType.class);
        Marshaller marshaller = context.createMarshaller();
        marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);

        @SuppressWarnings({ "rawtypes", "unchecked" })
        JAXBElement jaxbElement = new JAXBElement(new QName("snapshot"), JBossV6SnapshotType.class, jb);
