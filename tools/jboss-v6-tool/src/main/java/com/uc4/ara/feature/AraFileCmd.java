...
public class AraFileCmd {
	...
	public static void main(String[] args) {
		FeatureUtil.logMsg("jboss-v6-tool", MsgTypes.GENERAL);
		FeatureUtil.logMsg("(c) Automic Software GmbH", MsgTypes.GENERAL);
		try {			
			FeatureUtil.logMsg("Version: "
					+ FeatureUtil.getCompiledVersion("jboss-v6-tool"), MsgTypes.GENERAL);
			
			FeatureUtil.logMsg("Date: "
					+ FeatureUtil
					.getCompiledDate("jboss-v6-tool"), MsgTypes.GENERAL);
			FeatureUtil.logMsg("");
