...
import com.uc4.ara.feature.jbossv6.schemas.Datasources;
import com.uc4.ara.feature.jbossv6.schemas.DomainServerInfo;
import com.uc4.ara.feature.jbossv6.schemas.DomainServerSnapshot;
import com.uc4.ara.feature.jbossv6.schemas.DomainServerSnapshot.Deployments.Deployment;
import com.uc4.ara.feature.jbossv6.schemas.DomainServerSnapshot.Hosts;
import com.uc4.ara.feature.jbossv6.schemas.DomainServerSnapshot.Profiles;
import com.uc4.ara.feature.jbossv6.schemas.DomainServerSnapshot.ServerGroups;
import com.uc4.ara.feature.jbossv6.schemas.Extensions;
import com.uc4.ara.feature.jbossv6.schemas.Extensions.Extension;
import com.uc4.ara.feature.jbossv6.schemas.GeneralDataSource;
import com.uc4.ara.feature.jbossv6.schemas.Host;
import com.uc4.ara.feature.jbossv6.schemas.Host.Servers;
import com.uc4.ara.feature.jbossv6.schemas.Interface;
import com.uc4.ara.feature.jbossv6.schemas.Interfaces;
import com.uc4.ara.feature.jbossv6.schemas.JdbcDriver;
import com.uc4.ara.feature.jbossv6.schemas.JmsQueue;
import com.uc4.ara.feature.jbossv6.schemas.JmsTopic;
import com.uc4.ara.feature.jbossv6.schemas.Messaging;
import com.uc4.ara.feature.jbossv6.schemas.Messaging.HornetqServer;
import com.uc4.ara.feature.jbossv6.schemas.Profile;
import com.uc4.ara.feature.jbossv6.schemas.Server;
import com.uc4.ara.feature.jbossv6.schemas.ServerGroup;
import com.uc4.ara.feature.jbossv6.schemas.ServerGroupDeployment;
import com.uc4.ara.feature.jbossv6.schemas.ServerInfo;
import com.uc4.ara.feature.jbossv6.schemas.ServerSnapshotType;
import com.uc4.ara.feature.jbossv6.schemas.SocketBindingGroup;
import com.uc4.ara.feature.jbossv6.schemas.SocketBindingGroup.SocketBindings.SocketBinding;
import com.uc4.ara.feature.jbossv6.schemas.SocketBindingGroups;
import com.uc4.ara.feature.jbossv6.schemas.StandaloneDeployment;
import com.uc4.ara.feature.jbossv6.schemas.StandaloneServerInfo;
import com.uc4.ara.feature.jbossv6.schemas.StandaloneServerSnapshot;
import com.uc4.ara.feature.jbossv6.schemas.SubSystems;
import com.uc4.ara.feature.jbossv6.schemas.SubSystems.Subsystem;
import com.uc4.ara.feature.jbossv6.schemas.SystemProperties;
import com.uc4.ara.feature.jbossv6.schemas.SystemProperties.SystemProperty;
import com.uc4.ara.feature.jbossv6.schemas.XaDataSource;
import com.uc4.ara.util.Logger;

public class ServerSnapshot extends AbstractJBossV6Feature {
    ...
    public ServerSnapshotType createSnapshot()  throws JBossCLIException {
        ...
        if (!isDomain) {
            ...
            snapshot.setDeployments((com.uc4.ara.feature.jbossv6.schemas.StandaloneServerSnapshot.Deployments) getDeployments(root));
            ...
            snapshot.setName("Server Snapshot");
            snapshot.setDeployments((com.uc4.ara.feature.jbossv6.schemas.DomainServerSnapshot.Deployments) getDeployments(root));
